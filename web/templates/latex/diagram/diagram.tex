...
\newcommand*{\drawLabel}[2]{
    ...
    \ifthenelse{\equal{\style@label}{}}{}{
        ...
        \FPeval{\labelDistance}{\style@labelDistance}
        ...
        % otherwise we are safe to compute the slope
            ...
            \FPeval{\x}{root(\labelDistance * \labelDistance / (1 + \slope * \slope),2)/72.27}
        ...
        \draw (\labelX,\labelY) node {\style@label};
    }
